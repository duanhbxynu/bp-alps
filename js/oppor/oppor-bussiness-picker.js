(function($, doc) {
	...
	vehicleTypeCodeButton.addEventListener('tap', function(event) {
		vehicleTypeCodePicker.show(function(items) {
			...
			vehicleTypeCodeButton.setAttribute('data-value',items[0].value);
	...
	vehicleCategoryCodeButton.addEventListener('tap', function(event) {
		vehicleCategoryCodePicker.show(function(items) {
			...
			vehicleCategoryCodeButton.setAttribute("data-value", items[0].value);
	...
	vehicleCodeButton.addEventListener('tap', function(event) {
		...
		vehicleCodePicker.show(function(items) {
			...
			vehicleCodeButton.setAttribute("data-value", items[0].value);
	...
	var colorButton = doc.getElementById('color');

	colorButton.addEventListener('tap', function(event) {
		colorPicker.show(function(items) {
			colorButton.innerHTML = items[0].text;

			colorButton.setAttribute("data-value", items[0].value);
